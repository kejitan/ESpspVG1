...
def predictk(model=None, inp=None, out_fname=None, checkpoints_path="./checkpoints"):

    print("model = ", model)
    if model is None and (checkpoints_path is not None):
        print("loading model from checkpoint", checkpoints_path)
    ...
    print("output_width = ",model.output_width)
    print("output_height =  ", model.output_height)
    print("input_width = ", model.input_width)
    print("input_height = ", model.input_height)
    print("n_classes = ", model.n_classes)
    ...
    for i, inp in enumerate(tqdm(inps)):
        if out_dir is None:
            ...
            if isinstance(inp, six.string_types):
                ...
                out_fname = os.path.join(out_dir, file + ".png")
